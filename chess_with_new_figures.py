...
""" New figures  -  Checker - moves like a checker, placed instead of pawns(W), Damka - moves like bishop, but beats like in the game of checkers, not chess, placed instead of knight (I), Demolisher - moves like knight, but the rectangle is not 2-3, it is 3-3, placed instead of bishops(D) """
...
class Demolisher(Figure, Board):
    ...
    def set_moves(self):
        ...
        knight_list = [[x + 3, y + 3], [x - 3, y + 3], [x + 3, y - 3], [x - 3, y - 3]]
...
class Cheat_move(Board):
    ...
    def set_figure(self):
        ...
        if figure_name == "p":
            self.figure = Checker(self.color, self.cor, self.board)
        elif figure_name == "d":
            self.figure = Demolisher(self.color, self.cor, self.board)
        elif figure_name == "r":
            ...
            self.figure = Damka(self.color, self.cor, self.board)
...
class Move(Board):
    ...
    def set_figure(self):
        ...
        if figure_name == "w":
            ...
            self.figure = Demolisher(self.color, self.from_cor, self.board)
        elif figure_name == "r":
