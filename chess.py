...
class Board():
    ...
    def board_init(self):
        ...
        self.board = ["8rnbqkbnr8", "7pppppppp7", "6••••••••6", "5••••••••5", "4••••••••4", "3••••••••3", "2PPPPPPPP2", "1RNBQKBNR1"]
...
class Gameplay():
    ...
    def check_input(self, inp: str) -> list or bool:
        ...
        try:
            ...
            if len(coordinates) == 2 and len(inp) == 5 and check_coordinates(coordinates):
                self.change_status()
                return coordinates
            else:
                return wrong_input()
